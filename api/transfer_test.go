...
import (
	...
	"github.com/gerardoavelar/simplebank/token"
...
func TestTransferAPI(t *testing.T) {
	...
	account1.CurrencyCode = util.USD
	account2.CurrencyCode = util.USD
	account3.CurrencyCode = util.MXN
